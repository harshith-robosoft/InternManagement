...
const RejectedCVDrawer = (props) => {
  ...
  const candidateId =
    "https://app-internmanagement-221205180345.azurewebsites.net/intern-management/recruiter/extended-cv/" +
    idApi;
  ...
  const deleteCandidate = async () => {
    try {
      const response = await axios.put(
        " https://app-internmanagement-221205180345.azurewebsites.net/intern-management/recruiter/candidate-deletion",
        idApi,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("auth")}`,
...
export default RejectedCVDrawer;
