...
const RejectedCV = () => {
  ...
  const reRecruit = async () => {
    try {
      const response = await axios.put(
        "https://app-internmanagement-221205180345.azurewebsites.net/intern-management/recruiter/candidate-recruitment",
        idApi,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("auth")}`,
  ...
  return (
    <>
      ...
      >
        <RejectedDrawer toggleDrawer={toggleDrawer} />
      </Drawer>
        ...
        <div className="RejCV-mainDivComponents">
          ...
          <div className="RejCV-assignDiv">
            <div className="RejCV-header">
              <div className="RejCV-CVText">Rejected CV</div>
                ...
                <div className="RejCV-CandidateInfo">
                  <div className="RejCV-CandidateData">
                    ...
                    <div className="RejCV-CandidateArrow">
                      <img
                        className="RejCV-CandidateArrowImage"
                        src={arrow}
                        alt="arrowImage"
                      />
                    </div>
            ...
            <div className="rejCVCards">
              {searched
                ? rejSearchedData?.info?.map((data) => {
                    return (
                      <div className="rejCVCard">
                        <div
                          className="rejCVPhoto"
                          onClick={() => {
                            dispatch(addId(data?.applicationId));
                            toggleDrawer();
                          }}
                        >
                          <div>
                            <img
                              src={data?.imageUrl}
                              alt="image"
                              className="rejCVProfileImg"
                            />
                          </div>
                          <div className="rejCVPhotoInfo">
                            <div className="rejCVName">{data?.name}</div>
