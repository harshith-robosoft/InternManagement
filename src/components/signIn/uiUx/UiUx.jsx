...
import CVDrawerRej from '../cvDrawerRej/CVDrawerRej';
...
const UiUx = () => {
    ...
    const profileNew = `${BASE_URL}/intern-management/recruiter/profiles/` + tech + "/assigned";
    const profileShort = `${BASE_URL}/intern-management/recruiter/profiles/` + tech + "/shortlisted ";
    const profileRej = `${BASE_URL}/intern-management/recruiter/profiles/` + tech + "/rejected";
                        ...
                        <div className="UiUx-components">
                            <div className="UiUx-header">
                                ...
                                <div className='UiUx-headerRight'>
                                    ...
                                    <div>
                                        <img src={profile?.data?.info?.profileImage} alt="image" className="UiUx-hrImg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='UiUx-progressBars'>
                                <div className='UiUx-newBar UiUxBar'>
                                    <div className='UiUx-newImageBar' style={{ width: `${newRes}%` }}>
                                ...
                                <div className='UiUx-shortListedBar UiUxBar'>
                                    <div className='UiUx-shortImageBar' style={{ width: `${short}%` }}>
                                        <div className='UiUx-newBarInfo'>
                                            <div>
                                ...
                                <div className='UiUx-rejectedBar UiUxBar'>
                                    <div className='UiUx-rejImageBar' style={{ width: `${rej}%` }}>
                                        <div className='UiUx-newBarInfo'>
                                            <div>
                            ...
                            <div className='UiUx-pplList'>
                                ...
                                <div className='UiUx-newPplData'>
                                    {newList?.info.map((newList) => {
                                        ...
                                        return (
                                            <div className='UiUx-pplItem' onClick={() => { toggleDrawer(); dispatch(addId(newList?.candidateId)); }}>
                                ...
                                <div className='UiUx-newPplData'>
                                    {shortList?.info.map((shortList) => {
                                        ...
                                        return (
                                            <div className='UiUx-pplItem' onClick={() => { toggleDrawer(); dispatch(addId(shortList?.candidateId)); }}>
                                                <div className='UiUx-pplNameImage'>
                                                    <div>
                                ...
                                <div className='UiUx-newPplData'>
                                    {rejList?.info.map((rejList) => {
                                        ...
                                        return (
                                            <div className='UiUx-pplItem' onClick={() => { toggleDrawerRej(); dispatch(addId(rejList?.candidateId)); }}>
                                                <div className='UiUx-pplNameImage'>
                                                    <div>
