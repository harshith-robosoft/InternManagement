...
export const cardDataByDay = () =>
axios.get(`https://app-internmanagement-221205180345.azurewebsites.net/intern-management/recruiter/invites-by-day`, {
  headers: {
    Authorization: `Bearer ${sessionStorage.getItem("auth")}`,
  },
  data: {
...
// export const candidateInvit = async (userData) => {
